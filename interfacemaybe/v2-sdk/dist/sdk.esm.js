...
const WETH = {
  [ChainId.MAINNET]: /*#__PURE__*/new Token(ChainId.MAINNET, '0xacA2c8c66db0EEaBC18Eb60C114F67def14ff5D5', 18, 'WETH', 'Wrapped Ether'),
  [ChainId.ROPSTEN]: /*#__PURE__*/new Token(ChainId.ROPSTEN, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'),
  [ChainId.RINKEBY]: /*#__PURE__*/new Token(ChainId.RINKEBY, '0xc778417E063141139Fce010982780140Aa0cD5Ab', 18, 'WETH', 'Wrapped Ether'),
  [ChainId.GÖRLI]: /*#__PURE__*/new Token(ChainId.GÖRLI, '0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6', 18, 'WETH', 'Wrapped Ether'),
  [ChainId.KOVAN]: /*#__PURE__*/new Token(ChainId.KOVAN, '0xd0A1E359811322d97991E03f863a0C30C2cF029C', 18, 'WETH', 'Wrapped Ether')
};
...
class Route {
  constructor(pairs, input, output) {
    ...
    !pairs.every(pair => pair.chainId === pairs[0].chainId) ? process.env.NODE_ENV !== "production" ? invariant(false, 'CHAIN_IDS') : invariant(false) : void 0;
...
class Fetcher {
  ...
  static fetchTokenData(chainId, address, provider, symbol, name) {
    try {
      ...
      return Promise.resolve(_temp ? _temp2(TOKEN_DECIMALS_CACHE[chainId][address]) : Promise.resolve(new Contract(address, ERC20, provider).decimals().then(decimals => {
